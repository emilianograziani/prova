...
public abstract class AbstractPersonaggio {
	...
	private boolean giocatoreHaSalutato;
	...
	public AbstractPersonaggio(String nome, String presentaz) {
		...
		this.giocatoreHaSalutato = false;
	}
	...
	public void setGiocatoreHaSalutato(boolean risultato) {
		this.giocatoreHaSalutato = risultato;
	}
	
	public boolean getGiocatoreHaSalutato() {
		return this.giocatoreHaSalutato;
	}
