...
/**Una classe che permette di costruire un labirinto
 * concatenando metodi che inseriscono stanze e attrezzi e aggiungono adiacenze
 * restituendo un labirinto alla fine
 * @see Stanza
 * @see Labirinto
 * @see Attrezzo
 * @version homework3*/
